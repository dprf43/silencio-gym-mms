    ...
    <div class="flex-1">
        ...
        <div class="p-6">
            ...
            <div class="mb-6">
                ...
                <h2 class="text-2xl font-bold text-gray-900 mt-2">Create New Member</h2>
            </div>
                ...
                <form method="POST" action="{{ route('members.store') }}" class="space-y-6">
                    ...
                    <div>
                        ...
                        <select id="membership" name="membership" required 
                            ...
                            <option value="basic" {{ old('membership') == 'basic' ? 'selected' : '' }}>Basic</option>
                            <option value="premium" {{ old('membership') == 'premium' ? 'selected' : '' }}>Premium</option>
